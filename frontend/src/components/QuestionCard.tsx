import { LockIcon, CheckIcon, CodeIcon } from './icons';
...
export function QuestionCard({
  ...
  const statusConfig = {
    ...
    active: {
      icon: CodeIcon,
      color: '#E50914',
      bgOpacity: 'bg-[var(--blood-red)]/10',
      borderColor: 'border-[var(--blood-red)]/50',
    ...
    completed: {
      icon: CheckIcon,
      color: '#FF6A3D',
      bgOpacity: 'bg-[var(--ember-orange)]/10',
      borderColor: 'border-[var(--ember-orange)]/40',
      textColor: 'text-[var(--ash-gray)]',
      glow: '0 0 15px rgba(255, 106, 61, 0.3)',
    },
  };
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at top left, rgba(229, 9, 20, 0.05) 0%, transparent 50%)',
        }}
      />
      ...
      <div className="relative flex items-start gap-4">
        ...
        <div
          className={`
            ...
            ${status === 'active' ? 'animate-pulse-red' : ''}
          `}
          style={{
